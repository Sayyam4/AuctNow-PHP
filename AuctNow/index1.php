    ...
    <head>
		...
		<script>		
			...
			var x = setInterval(function() {
				...
				document.getElementById("time_counter").innerHTML = days + "d " + hours + "h " + minutes + "m " + seconds + "s ";
				document.getElementById("time_counter1").innerHTML = days + "d " + hours + "h " + minutes + "m " + seconds + "s ";
				document.getElementById("time_counter2").innerHTML = days + "d " + hours + "h " + minutes + "m " + seconds + "s ";
				document.getElementById("time_counter3").innerHTML = days + "d " + hours + "h " + minutes + "m " + seconds + "s ";
				document.getElementById("time_counter4").innerHTML = days + "d " + hours + "h " + minutes + "m " + seconds + "s ";
				document.getElementById("time_counter5").innerHTML = days + "d " + hours + "h " + minutes + "m " + seconds + "s ";
				document.getElementById("time_counter6").innerHTML = days + "d " + hours + "h " + minutes + "m " + seconds + "s ";
				document.getElementById("time_counter7").innerHTML = days + "d " + hours + "h " + minutes + "m " + seconds + "s ";
				if (distance < 0) {
					clearInterval(x);
					document.getElementById("time_counter").innerHTML = "EXPIRED";				
				}
			}, 1000);
		</script>
		<!-- Timer Js End-->
							...
							<div class="product__item">
								...
								<div class="product__item__text">
									...
									<div class="product__details__button">
										<a href="product-details.html" class="cart-btn"><span class="icon_bag_alt"></span> Bid</a>
									</div>
						...
						<div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
							<div class="product__item sale">
								...
								<div class="product__item__text">
									...
									<div class="product__price" style="color:black;">$ 49.0 </div>
									<h6>Ends in:</h6> 
									<p id="time_counter5"></p> 
